...
for(Note note:list){
	...
	<div class="card mt-3" >
  <img class="card-img-top m-2 mx-auto" src="img/notes.png" style="max-width:100px" alt="Card image cap">
  <div class="card-body mx-5">
    <h5 class="card-title"><%=note.getTitle() %></h5>
    <p class="card-text"><%=note.getContent() %></p>
    
    <p><b>
    <!-- this is only for date so comment -->
  <!--    <p ><b class="text-primary"><%=DateFormat.getDateInstance().format(note.getAddedDate()) %></b></p>-->
